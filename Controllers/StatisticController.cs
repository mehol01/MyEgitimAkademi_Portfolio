...
namespace MyEgitimAkademi_Portfolio.Controllers
{
    public class StatisticController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            double floatwithtwodigitsaftercomma = Convert.ToDouble(db.Project.Average(x=>x.Price));
            string stringofthefloat = floatwithtwodigitsaftercomma.ToString("0.00");

            ViewBag.avgPrice = stringofthefloat;
